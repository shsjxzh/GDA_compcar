...
opt.src_domain = list(range(0,12))
opt.tgt_domain = list(range(12,30))
...
opt.num_input = 2    # the x data dimension
...
# sampling number
opt.sample_v =  22 # 27 # 27 # 4 # 14 # 27 # 14     # the sample number for d's training
